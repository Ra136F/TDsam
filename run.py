...
if __name__ == '__main__':
    ...
    parser.add_argument('-lambda_value', type=float, default=0.01, help="采样率")
    parser.add_argument("-start_ori_time", type=int, default=0, help="开始传输原始数据的时间")
    parser.add_argument("-second_lambda",type=float,default=0.002,help="降低后的采样率")
